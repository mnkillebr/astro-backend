...
virgo = Sign.create(image: "https://images-na.ssl-images-amazon.com/images/I/71UlLzdwsoL._SX425_.jpg", name: "Virgo", date_range: "8/23-9/22", description: "The masterful helper of the horoscope wheel, Virgo energy teaches us to serve, do impeccable work and prioritize wellbeing—of ourselves, our loved ones and the planet.", traits: "Loyal, analytical, hardworking, shyness, worry, Overly critical of self and others")
libra = Sign.create(image: "https://images-na.ssl-images-amazon.com/images/I/71JJD1Xm2dL._SX425_.jpg", name: "Libra", date_range: "9/23-10/22", description: "The balanced beautifier of the horoscope family, Libra energy inspires us to seek peace, harmony and cooperation—and to do it with style and grace.", traits: "diplomatic, gracious, social, Indecisive, avoids confrontations, self-pity")
...
sagittarius = Sign.create(image: "https://images-na.ssl-images-amazon.com/images/I/71iCJL38ybL._SX425_.jpg", name: "Sagittarius", date_range: "11/22-12/21", description: "The worldly adventurer of the horoscope wheel, Sagittarius energy inspires us to dream big, chase the impossible and take fearless risks.", traits: "Generous, idealistic, great sense of humor, promises more than can deliver, impatient")
capricorn = Sign.create(image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpxAR_I8H1PZXvTgUbcmXMqV0iOH-si0J-_Wk8_vRg6dOvQZ22", name: "Capricorn", date_range: "12/22-1/19", description: "The measured master planner of the horoscope family, Capricorn energy teaches us the power of structure and long-term goals.", traits: "Responsible, disciplined, self-control, know-it-all, unforgiving, condescending")
...
cancer = Sign.create(image: "https://images-na.ssl-images-amazon.com/images/I/71Sf4uAl-tL._SX425_.jpg", name: "Cancer", date_range: "6/21-7/22", description: "The natural nurturer of the horoscope wheel, Cancer energy helps us connect with our feelings, plant deep roots and feather our family nests.", traits: "Tenacious, highly imaginative, loyal, emotional, sympathetic, persuasive, moody, suspicious, manipulative, insecure")
